...
const login = async (req, res, next) => {
    try {
        ...
        // Esta funcion asincrona automaticamente compara las contraseñas, y devuelve un boolean
        if (bcrypt.compareSync(password, user.password)) {
            // Logica interna del Login

            // Primero va la comprobacion de contraseña, que se hace con jwt json web token
        ...
        // Si llega hasta acá es porque compareSync dio false, no coinciden las contraseñas.
